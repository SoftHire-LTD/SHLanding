...
export default function ImmigrationCompliancePage() {
  ...
  return (
    <>
      <SEO
        title="Immigration Compliance for Recruitment Agencies | Right to Work & Sponsor Licence | SoftHire"
        description="Placing the wrong candidate can cost your agency up to £60,000 per worker. SoftHire keeps your right to work compliance and sponsor licence obligations airtight — UK-wide."
        path="/immigration-compliance"
        breadcrumb={[{ name: 'Immigration Compliance for Recruitment Agencies' }]}
