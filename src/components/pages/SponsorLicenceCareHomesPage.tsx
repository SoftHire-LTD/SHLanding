...
export default function SponsorLicenceCareHomesPage() {
  ...
  return (
    <>
      <SEO
        title="Sponsor Licence for Care Homes | UK Immigration for the Care Sector | SoftHire"
        description="CQC-registered care homes can sponsor overseas workers under the Health and Care Worker visa. SoftHire handles your licence application and keeps your care home audit-ready."
        path="/sponsor-licence-care-homes"
        breadcrumb={[{ name: 'Sponsor Licence for Care Homes' }]}
