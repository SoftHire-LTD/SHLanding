...
export default function SponsorLicenceTechStartupsPage() {
  ...
  return (
    <>
      <SEO
        title="Sponsor Licence for Tech Startups | Skilled Worker Visas for Startups | SoftHire"
        description="Pre-revenue startups can hold a UK sponsor licence. SoftHire builds your HR compliance framework and manages sponsor licence applications for growing tech companies."
        path="/sponsor-licence-tech-startups"
        breadcrumb={[{ name: 'Sponsor Licence for Tech Startups' }]}
