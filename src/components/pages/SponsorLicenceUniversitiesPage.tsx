...
export default function SponsorLicenceUniversitiesPage() {
  ...
  return (
    <>
      <SEO
        title="Sponsor Licence for Universities | Student & Worker Sponsorship | SoftHire"
        description="UK universities managing student and worker sponsorship simultaneously. SoftHire provides the compliance infrastructure and audit support that Higher Education institutions need."
        path="/sponsor-licence-universities"
        breadcrumb={[{ name: 'Sponsor Licence for Universities' }]}
