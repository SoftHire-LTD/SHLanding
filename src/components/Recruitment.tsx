        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {targetIndustries.map((industry, index) => (
              <div key={index} className="bg-accent-100 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 border border-accent-200">
                <div className="flex items-center mb-6">
                  <div className="bg-primary-200 p-3 rounded-lg mr-4">
                    <industry.icon className="h-8 w-8 text-primary-700" />
                  </div>
                  <h3 className="text-2xl font-bold text-primary-900">{industry.title}</h3>
                </div>
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold text-primary-900 mb-3">Popular Roles:</h4>
      ...
      <section className="py-20 bg-primary-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* For Employers */}
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-accent-200">
              <div className="flex items-center mb-6">
                <Building2 className="h-8 w-8 text-primary-700 mr-3" />
                <h3 className="text-2xl font-bold text-primary-900">For Employers</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Access to pre-screened candidates with relevant skills</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Sponsor license verification and compliance tracking</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Automated visa status monitoring and alerts</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Streamlined interview and hiring process</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-accent-200">
              <div className="flex items-center mb-6">
                <Users className="h-8 w-8 text-primary-700 mr-3" />
                <h3 className="text-2xl font-bold text-primary-900">For Candidates</h3>
              </div>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Exclusive access to sponsored job opportunities</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Verified sponsor license holding employers</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Visa application guidance and support</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent-400 mt-0.5 flex-shrink-0" />
                  <span className="text-primary-700">Career development and skills matching</span>
                </li>
              </ul>
            </div>
          </div>
