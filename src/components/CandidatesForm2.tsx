...
const CandidatesForm2 = () => {
  ...
  return (
    <>
      <SEO
        title="Apply for UK Visa Sponsorship | Candidate Application | SoftHire"
        description="International candidates — submit your details to SoftHire for UK visa sponsorship support. IAA-regulated assistance for Student, Graduate, and Skilled Worker visa routes."
        path="/candidates"
        breadcrumb={[{ name: 'Candidate Application' }]}
      />
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="text-center pt-6">
                  ...
                  <p className="text-charcoal-600 mt-4 text-sm">
                    ...
                    <a href="/privacy-policy.pdf" className="underline text-blue-500">Privacy Policy</a>
                    {' '}and consent to SoftHire processing your personal data for visa sponsorship purposes.
                  </p>
                </div>
              </form>
            </div>
